    ...
    public partial class migration1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TickedInCards", x => new { x.TicketId, x.CardId });
                    table.ForeignKey(
                        name: "FK_TickedInCards_Tickets_CardId",
                        column: x => x.CardId,
                        principalTable: "Tickets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TickedInCards_Cards_TicketId",
                        column: x => x.TicketId,
